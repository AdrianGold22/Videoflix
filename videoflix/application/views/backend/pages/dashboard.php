<div class="row">
	...
	<div class="col-md-4 col-sm-12 ">
		<div class="tiles blue weather-widget ">
			<div class="tiles-body">
				<div class="heading">
					<div class="pull-left"> Libros Totales </div>
	...
	<div class="col-md-4 col-sm-12 ">
		<div class="tiles purple weather-widget ">
			<div class="tiles-body">
				<div class="heading">
					<div class="pull-left"> Articulos Totales </div>
					<div class="pull-right"> 
...
<div class="row">
	...
	<div class="col-md-4 col-sm-12 ">
		<div class="tiles black  weather-widget ">
			<div class="tiles-body">
				<div class="heading">
					<div class="pull-left"> Total de usarios </div>
					<div class="pull-right">
	...
	<!-- TOTAL ACTIVE SUBSCRIPTION --><!-- PENDIENTE A ELIMINAR -->
	<div class="col-md-4 col-sm-12 ">
	...
	<!-- REVENUE THIS MONTH --> <!-- PENDIENTE A ELIMINAR -->
	<div class="col-md-4 col-sm-12 ">
