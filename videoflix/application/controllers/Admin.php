...
class Admin extends CI_Controller {
	...
	function dashboard()
	{
		...
		$page_data['page_title']	=	'Inicio - Resumen';
	...
	function genre_list()
	{
		...
		$page_data['page_title']	=	'Gestionar tematicas';
		$this->load->view('backend/index', $page_data);
	}
	...
	function genre_create()
	{
		...
		$page_data['page_title']	=	'Crear tematica';
		$this->load->view('backend/index', $page_data);
	}
	...
	function genre_edit($genre_id = '')
	{
		...
		$page_data['page_title']	=	'Editar tematica';
		$this->load->view('backend/index', $page_data);
	}
	...
	function movie_list()
	{
		...
		$page_data['page_title']	=	'Gestionar libros';
		$this->load->view('backend/index', $page_data);
	}
	...
	function movie_edit($movie_id = '')
	{
		...
		$page_data['page_title']	=	'Editar libro';
		$this->load->view('backend/index', $page_data);
	}
	...
	function series_list()
	{
		...
		$page_data['page_title']	=	'Gestionar Articulos';
		$this->load->view('backend/index', $page_data);
	}
	...
	function series_create()
	{
		...
		$page_data['page_title']	=	'Crear articulo';
		$this->load->view('backend/index', $page_data);
	}
	...
	function series_edit($series_id = '')
	{
		...
		$page_data['page_title']	=	'Editar articulo';
		$this->load->view('backend/index', $page_data);
	}
	...
	function actor_list()
	{
		...
		$page_data['page_title']	=	'Gestionar autores';
		$this->load->view('backend/index', $page_data);
	}
	...
	function actor_create()
	{
		...
		$page_data['page_title']	=	'Crear autores';
		$this->load->view('backend/index', $page_data);
	}
	...
	function actor_edit($actor_id = '')
	{
		...
		$page_data['page_title']	=	'Editar autor';
		$this->load->view('backend/index', $page_data);
	}
